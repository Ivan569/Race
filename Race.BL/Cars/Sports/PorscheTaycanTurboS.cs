...
{
    /// <summary>
    /// Автомобиль Porsche Taycan Turbo S.
    /// </summary>
    class PorscheTaycanTurboS : Car
    {
        /// <summary>
        /// Достичь финиша.
        /// </summary>
        ...
        {
            speed = StaticRandom.random.Next(100, 290);
        ...
        public override string ToString() => "Porsche Taycan Turbo S";
    }
}