...
namespace ConsoleApp12.Race.BL.Cars.TheBuses
{
    /// <summary>
    /// Автобус Groove Vector Next.
    /// </summary>
    class GrooveVectorNext : Car
    {
        /// <summary>
        /// Достичь финиша.
        /// </summary>
        ...
        {
            speed = StaticRandom.random.Next(40, 120);
        ...
        public override string ToString() => "Groove Vector Next";
    }
}